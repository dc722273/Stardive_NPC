#!/usr/bin/env python3
"""Run the frozen NPC loop Godot oracle.
...
PASS_MARKER = "NPC_LOOP_ORACLE: PASS"


def main() -> int:
    repo_root = Path(__file__).resolve().parents[3]
    godot_ps1 = repo_root / "tools" / "godot" / "godot.ps1"
    oracle_script = "apr/npc-loop/oracle/npc_loop_oracle.gd"
    ...
    assert PASS_MARKER in output, (
        "NPC loop oracle did not print PASS marker. "
